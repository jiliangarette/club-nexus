...
Route::middleware(['auth', 'verified', 'active'])->group(function () {
    ...
    Route::get('/',
        [HomeController::class, 'home'])->name('feed');
    ...
    Route::get('chat/club/{group}',
        [MessageController::class, 'byGroup'])->name('chat.group');

    Route::get('/message/older/{message}',
        [MessageController::class, 'loadOlder'])->name('message.loadOlder');

    Route::post('/message',
        [MessageController::class, 'store'])->name('message.store');

    Route::delete('/message/{message}',
        [MessageController::class, 'destroy'])->name('message.destroy');

    Route::get('feed/club/{group}',
        [PostController::class, 'byGroup'])->name('feed.group');

    Route::post('/post',
        [PostController::class, 'store'])->name('post.store');

    Route::post('/group',
        [GroupController::class, 'store'])->name('group.store');

    Route::put('/group/{group}',
        [GroupController::class, 'update'])->name('group.update');
